...
import { CheckCircle2, ChevronRight, Lock, Sparkles, AlertCircle, ArrowRight, ShieldCheck, CreditCard, ArrowLeft, Copy } from 'lucide-react';
...
export default function CheckoutPage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Son 24 saat içerisinde yapılmış bir istek var mı kontrolü
            ...
            if (recentRequest && recentRequest.length > 0) {
                // Eğer zaten varsa eklemeden doğrudan başarılı sayfasına geçir
                setIsSuccess(true);
                setHasPending(true);
                return;
            }
            ...
            // Telegram'a arka planda bildirim gönder
            const userEmail = user.email || 'Bilinmeyen Mail';
            const fullName = userName || 'İsimsiz';
            const phoneStr = userPhone || 'Bilinmeyen Numara';
            const message = `🚨 <b>YENİ ÖDEME BİLDİRİMİ!</b>\n\n👤 <b>İsim:</b> ${fullName}\n📱 <b>Telefon:</b> ${phoneStr}\n📧 <b>E-posta:</b> ${userEmail}\n🕒 <b>Tarih:</b> ${new Date().toLocaleString('tr-TR')}\n\n👉 Lütfen admin paneline girip ödemeyi onaylayın.`;
