...
export default function StudentDashboard() {
    ...
    return (
        <div className="space-y-8">
            {/* Header Section */}
            <FadeIn>
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4 border-b pb-6">
                    <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-4 md:gap-6">
                        ...
                        <div>
                            <h1 className="text-3xl font-black tracking-tighter text-foreground leading-tight">
                                Hoş Geldin, <br className="md:hidden" /><span className="bg-gradient-to-r from-purple-500 to-indigo-600 bg-clip-text text-transparent">{userName.split(' ')[0]}</span> 👋
                            </h1>
                            <p className="text-muted-foreground font-medium mt-2 md:mt-1">
                    ...
                    <SpotlightCard className="group relative p-6 h-full border-indigo-500/20 bg-gradient-to-br from-neutral-900 via-indigo-950/10 to-neutral-950 overflow-hidden flex flex-col justify-center">
                        ...
                        <div className="relative z-10 flex flex-col justify-center h-full min-h-[140px]">
                            <div className="flex flex-col xl:flex-row xl:items-center gap-8 xl:gap-12">
                                ...
                                {/* Course List */}
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-rows-3 xl:grid-flow-col gap-x-4 lg:gap-x-12 gap-y-3 xl:my-auto xl:translate-y-6 w-full">
                                    {[
                                        ...
                                        <div key={index} className="flex items-center gap-3 min-w-0">
                                            <div className="w-1.5 h-1.5 rounded-full bg-indigo-500/50 shrink-0"></div>
                                            <span className="text-sm font-medium text-indigo-100/70 group-hover:text-indigo-300 transition-colors tracking-tight truncate pb-1">
                                                {course}
                                            </span>
                                        </div>
                                    ))}
                    ...
                    <div className="space-y-3">
                        {recentMaterials.length === 0 ? (
                            ...
                            recentMaterials.map((material) => (
                                <Link href={`/dashboard/notlar/${material.id}`} key={material.id}>
