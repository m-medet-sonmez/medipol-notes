...
const PDFViewer = dynamic(() => import('@/components/materials/PDFViewer').then(mod => mod.PDFViewer), { ssr: false });
        ...
        <div className="space-y-8 pb-12">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <Badge variant="outline" className="text-primary border-primary/20 bg-primary/5">
                                    {material.course?.course_code || 'Bilinmeyen Ders'}
                                </Badge>
                                <Badge variant="secondary">
                                    {material.week?.week_name || 'Bilinmeyen Hafta'}
                                </Badge>
                            </div>
            ...
            {signedPdfUrl ? (
                <div className="space-y-4">
                    ...
                    <PDFViewer fileUrl={signedPdfUrl} />
                </div>
            ) : (
