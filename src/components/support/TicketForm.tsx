...
export function TicketForm({ onSuccess, onCancel }: { onSuccess?: () => void, onCancel?: () => void }) {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            // Arkaplanda adminlere mail yollayalım
            fetch('/api/admin/notify-question', {
                method: 'POST',
                ...
                body: JSON.stringify({
                    ...
                    category: values.category,
                    message: values.message,
                    userName: user.user_metadata?.full_name || 'KafaRahat Öğrencisi',
                    userEmail: user.email
                })
            }).catch(e => console.error('E-posta bildirim hatası:', e));
